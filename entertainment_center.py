...
# baby Boss
baby_boss = media.Movie(
    "Baby_Boss",
    "http://deavilavideo.com.br/loja2/wp-content/uploads/2017/06/O-PODEROSO-CHEFINHO.jpg",  # NOQA
    "https://www.youtube.com/watch?v=O2Bsw3lrhvs"
    )
# Frozen
frozen = media.Movie(
    "Frozen",
    "http://t0.gstatic.com/images?q=tbn:ANd9GcTIaSaZM-kGnMKWNNMW9-_yv008JrEh58Ab3DAV1geUNJvXeyXS",  # NOQA
    "https://www.youtube.com/watch?v=TbQm5doF_Uc"
    )
# Tangled
tangled = media.Movie(
    "Tangled",
    "http://i.ebayimg.com/00/s/NDk5WDM1OA==/z/0UgAAOxyVLNS-sa5/$_3.JPG?set_id=2",  # NOQA
    "https://www.youtube.com/watch?v=JYKpIr1lSG0"
    )
# Inside out
inside_Out = media.Movie(
    "Inside Out",
    "https://images-na.ssl-images-amazon.com/images/I/51g%2B1-GJCuL.jpg",  # NOQA
